...
{   int b1,b2,u;
    ...
    for (int i=0;i<x;i++)
    {
        ...
        /************************/
        equipe1.joueurlist[j-1].afficher_info();
       /************************/
...
void Match::afficher_information()
{
    ...
    cout<<"la premiere equipe  "<<equipe1.nom<<" "<<information[1]<<" a eu carton jaune et "<<information[2]<<"carton rouge"<<endl;
    cout<<"la deuxieme equipe "<<equipe2.nom<<" "<<information[4]<<" a eu carton jaune et "<<information[5]<<"carton rouge"<<endl;
}
